...
req.createPerson('Markon11', 'Spencor11');
...
var crudPhone = function() {
        ...
        //deletePhone
        driver.findElement(By.xpath("//table[starts-with(@id, 'phonesTable')]/tbody/tr[2]/td[9]/span/a[@title='Delete']")).click();
...
var crudEmail = function() {
    ...
    driver.findElement(By.xpath("//table[starts-with(@id, 'emailsTable')]/tbody/tr[2]/td[7]/span")).getText()
    .then(function(valueDoNotSendEmails) {
        assert.equal(valueDoNotSendEmails, 'Do not send emails');
    });

    //deleteEmail
    driver.findElement(By.xpath("//table[starts-with(@id, 'emailsTable')]/tbody/tr[2]/td[8]/span/a[@title='Delete']")).click();
    driver.wait(until.elementLocated(By.xpath("//section[@data-pe-id='confirmPopup']//button[@data-pe-id='confirm']")));
    driver.findElement(By.xpath("//section[@data-pe-id='confirmPopup']//button[@data-pe-id='confirm']")).click();
